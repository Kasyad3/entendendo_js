...
if (media >6){ mensagem = nome + "Você está Aprovado"
} else if (media <4){ mensagem = nome + " Você está Reprovado"
}else if (media =6,5,4){ mensagem = nome + "Você está em Recuperação"
}
alert(mensagem)